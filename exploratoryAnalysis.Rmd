...
miniData <- select(cleanData, contains("t") | starts_with("I"))
head(miniData) #only includes the titles and ratings
...
numberData #gives numerical rating values to each title
```
...
ggplot(data = numberData, aes(x = numeric_rating, y = rating_dif)) +
  geom_point()
